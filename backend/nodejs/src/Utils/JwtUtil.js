...
const JWT_PASSWORD_RESET_SECRET = process.env.JWT_PASSWORD_RESET_SECRET || "password_reset_secret";
const JWT_PASSWORD_RESET_EXPIRY = process.env.JWT_PASSWORD_RESET_EXPIRY || "1h";
...
const generatePasswordResetToken = (userId) => {
    const resetToken = jwt.sign({ userId }, JWT_PASSWORD_RESET_SECRET, { expiresIn: JWT_PASSWORD_RESET_EXPIRY });
    return resetToken;
};
